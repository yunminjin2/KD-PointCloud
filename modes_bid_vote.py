...
from pointconv_util_vote import PointConv, PointConvD, PointWarping, UpsampleFlow, CrossLayerLightVote as CrossLayer
from pointconv_util_vote import SceneFlowEstimatorResidual
from pointconv_util_vote import index_points_gather as index_points, index_points_group, Conv1d, square_distance
import time
...
class PointConvBidirection(nn.Module):
    def __init__(self):
        ...
        self.flow0 = SceneFlowEstimatorResidual(32 + 64, 32+3, weightnet = weightnet)
        ...
        self.flow1 = SceneFlowEstimatorResidual(64 + 64, 64+3, weightnet = weightnet)
        ...
        self.flow2 = SceneFlowEstimatorResidual(128 + 64, 128+3, weightnet = weightnet)
        ...
        self.flow3 = SceneFlowEstimatorResidual(256, 256+3, weightnet = weightnet)
