...
from pointconv_util2 import PointConv, PointConvD, PointWarping, UpsampleFlow, CrossLayerLight as CrossLayer, NoCrossLayerLight as NoCrossLayer,SceneFlowEstimatorResidual
...
class PointConvBidirection(nn.Module):
    def __init__(self):
        ...
        self.cross0 = NoCrossLayer(flow_nei, 32 + 32 , [32, 32], [32, 32])
        ...
        self.cross1 = NoCrossLayer(flow_nei, 64 + 32, [64, 64], [64, 64])
        ...
        self.cross2 = NoCrossLayer(flow_nei, 128 + 64, [128, 128], [128, 128])
        ...
        self.cross3 = NoCrossLayer(flow_nei, 256 + 64, [256, 256], [256, 256])
    ...
    def forward(self, xyz1, xyz2, color1, color2):
        ...
        #l3
        c_feat1_l3 = torch.cat([feat1_l3, feat2_l4_3], dim = 1)
        c_feat2_l3 = torch.cat([feat2_l3, feat1_l4_3], dim = 1)
        cross3 = self.cross3(pc1_l3, pc2_l3, c_feat1_l3, c_feat2_l3)
        ...
        c_feat1_l2 = torch.cat([feat1_l2, feat2_l3_2], dim = 1)
        c_feat2_l2 = torch.cat([feat2_l2, feat1_l3_2], dim = 1)

        #l2
        up_flow2 = self.upsample(pc1_l2, pc1_l3, self.scale * flow3)
        pc2_l2_warp = self.warping(pc1_l2, pc2_l2, up_flow2)
        cross2 = self.cross2(pc1_l2, pc2_l2_warp, c_feat1_l2, c_feat2_l2)
        ...
        c_feat1_l1 = torch.cat([feat1_l1, feat2_l2_1], dim = 1)
        c_feat2_l1 = torch.cat([feat2_l1, feat1_l2_1], dim = 1)


        #l1
        up_flow1 = self.upsample(pc1_l1, pc1_l2, self.scale * flow2)
        pc2_l1_warp = self.warping(pc1_l1, pc2_l1, up_flow1)
        cross1 = self.cross1(pc1_l1, pc2_l1_warp, c_feat1_l1, c_feat2_l1)
        ...
        cross0 = self.cross0(pc1_l0, pc2_l0_warp, c_feat1_l0, c_feat2_l0)
