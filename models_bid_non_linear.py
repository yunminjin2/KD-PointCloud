...
from pointconv_util3 import PointConv, PointConvD, PointConvNonLinear, PointWarping, UpsampleFlow, CrossLayerLight as CrossLayer, BottleNeck, ConvBNReLU
from pointconv_util3 import SceneFlowEstimatorResidual
...
class PointConvBidirection(nn.Module):
    def __init__(self):
        ...
        self.level0_1 = BottleNeck(32, 16, 32)
        ...
        self.level1_0 = BottleNeck(64, 32, 64)
        ...
        self.level2_0 = BottleNeck(128, 64, 128)
        self.level2_1 = Conv1d(128, 256)

        #l3: 256
        self.level3 = PointConvNonLinear(256, feat_nei, 256 + 3, 256)
        self.cross3 = CrossLayer(flow_nei, 256 + 64, [256, 256], [256, 256])
        self.flow3 = SceneFlowEstimatorResidual(256, 256)
        self.level3_0 = BottleNeck(256, 64, 256)
        self.level3_1 = Conv1d(256, 512)

        #l4: 64
        self.level4 = PointConvNonLinear(64, feat_nei, 512 + 3, 256)
